...
class MnistNet(nn.Module):
    ...
    #def __init__(self, loss_fn, num_in_channels=1):
        ...
        #self.add_module('fc1', nn.Linear(in_features = 64*6*6, out_features=600))
        self.add_module('fc1', nn.Linear(in_features = 64*5*5, out_features = num_classes))
        #self.add_module('fc2', nn.Linear(in_features=600, out_features=120))
        #self.add_module('fc3',nn.Linear(in_features = 120, out_features = num_classes)) 
